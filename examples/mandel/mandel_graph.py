...
t_step_array = np.array([100, 716, 1791, 3583, 7170])
...
ax.set(xlabel='Normalized Distance, x*', ylabel='Normalized Pressure, P*', title="Mandel's Problem: Normalized Pressure at y = 0")
fig.tight_layout()
fig.savefig('output/mandel_pressure_y_0.png',dpi = 300)
...
ax.set(xlabel='Normalized Distance, y*', ylabel='Normalized Pressure, P*', title="Mandel's Problem: Normalized Pressure at x = 0")
fig.tight_layout()
...
ax.set(xlabel='Normalized Distance, x*', ylabel='Normalized Displacement, U*', title="Mandel's Problem: Normalized X Displacement at y = 0")
fig.tight_layout()
...
ax.grid()
ax.legend(loc='lower left')
ax.set(xlabel='Normalized Distance, y*', ylabel='Normalized Displacement, U*', title="Mandel's Problem: Normalized Y Displacement at x = 0")
fig.tight_layout()
fig.savefig('output/mandel_displacement_y.png',dpi = 300)
